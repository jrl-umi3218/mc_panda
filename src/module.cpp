...
extern "C"
{
  ...
  ROBOT_MODULE_API mc_rbdyn::RobotModule * create(const std::string & n)
  {
    ...
    {
      return new mc_panda::PandaRobotModule(true, false, false);
    }
    else if(n == "PandaFoot")
    {
      return new mc_panda::PandaRobotModule(false, true, false);
    }
    else if(n == "PandaHand")
    {
      return new mc_panda::PandaRobotModule(false, false, true);
    }
    else
    {
